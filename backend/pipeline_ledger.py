...
class Ledger:
    ...
    plan: list = field(default_factory=lambda: [
        ...
        {"fase": 4, "nome": "agente_nicho", "desc": "Gerar briefing de nicho", "obrigatoria": False},
        {"fase": 5, "nome": "unsplash", "desc": "Buscar fotos", "obrigatoria": True},
        {"fase": 6, "nome": "arquiteto_mestre", "desc": "Gerar PRD", "obrigatoria": True},
        {"fase": 7, "nome": "builder_renderer", "desc": "Gerar site", "obrigatoria": True},
        {"fase": 8, "nome": "validador", "desc": "Auditar qualidade", "obrigatoria": True},
