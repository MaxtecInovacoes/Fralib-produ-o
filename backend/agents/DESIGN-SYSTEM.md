# DESIGN SYSTEM FRALIB - 52 Itens Obrigatórios
...
## 2. LGPD (5 itens)
- [ ] `banner_cookies` — Banner com botão "Aceitar" visível
- [ ] `politica_privacidade` — Link para política de privacidade
- [ ] `termos_uso` — Link para termos de uso
- [ ] `opt_in_explicito` — Checkbox de consentimento em formulários
- [ ] `botao_rejeitar_cookies` — Botão "Rejeitar" no banner de cookies
