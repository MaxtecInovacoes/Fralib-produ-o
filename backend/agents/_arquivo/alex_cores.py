...
SEGMENT_QUERIES = {
    ...
    "pet": "pet shop interior architecture animals",
    "veterinaria": "veterinary clinic interior architecture",
    "odontologia": "dental clinic interior architecture",
    "fisioterapia": "physiotherapy clinic interior architecture",
    "pilates": "pilates studio interior architecture",
    "yoga": "yoga studio interior architecture",
    "padaria": "bakery interior architecture bread",
    "lanchonete": "cafe restaurant interior architecture",
    "pizzaria": "pizza restaurant interior architecture",
    "farmacia": "pharmacy interior architecture",
    "imobiliaria": "real estate office interior architecture",
    "contabilidade": "accounting office interior architecture",
...
def classificar_fotos_por_tipo(fotos_webp, segmento) -> Dict:
    ...
    res = {
        ...
        "equipe": [], "produto": [], "outro": [], "watermark": [],
    }
    ent = []
    ...
    try:
        ...
        cp.append({"type": "text", "text": "Classifique fotos de {}. Formato: 1:fachada 2:ambiente_interno. Tipos: fachada|ambiente_interno|equipamento|equipe|produto|outro|watermark. Use 'watermark' para fotos com texto/marca d'agua de celular visivel (ex: nome do modelo do celular, nome de pessoa, data). Responda APENAS nesse formato.".format(segmento)})
        ...
        # Mapeamento de termos alternativos para 'equipe'
        TIPO_MAP = {
            "pessoa": "equipe", "pessoas": "equipe",
            "people": "equipe", "person": "equipe",
        }
