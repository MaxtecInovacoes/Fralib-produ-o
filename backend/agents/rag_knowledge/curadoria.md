# Conhecimento RAG - Curadoria (Processamento de Imagens)

## Missao
Processar imagens do lead, extrair paleta real do logo, salvar assets persistentes.
Os assets do Curadoria sao usados por todos os agentes seguintes - qualidade aqui = qualidade no site.

## Regras de Salvamento

### SEMPRE salvar em assets_dir persistente
- Caminho: /var/www/fralib/sites/{tenant_id}/{slug}/assets/
...
## Saida Esperada (CuradoriaOutput)
...
- assets_dir: caminho completo /var/www/fralib/sites/{tenant_id}/{slug}/assets/
