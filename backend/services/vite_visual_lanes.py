...
_FAMILY_COPY_DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "nutricionista": {
        ...
        "about_card_3_title": "Contato sem ruído",
    ...
    "barbearia": {
        ...
        "about_card_1_text": "{name} aparece com presença local, estética própria e leitura clara para quem procura corte e barba em {city}.",
        ...
        "services_city_body": "Serviços, presença local e reserva aparecem arrumados para decisão rápida.",
    ...
    "default": {
        ...
        "about_card_2_text": "As frentes de atendimento entram organizadas para leitura rápida e decisão sem ruído.",
        "about_card_3_title": "Marca em contexto",
        "about_card_3_text": "Ambiente, imagem e composição sustentam a identidade visual sem inventar promessa.",
        "about_city_label": "Cidade",
        "about_aside_body": "Contato direto, informação confirmada e uma narrativa visual coerente para quem está decidindo agora.",
