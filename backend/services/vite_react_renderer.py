...
const pillars = [
  { title: 'Presença local', text: `${siteCopy.name} aparece com cidade, contato e contexto alinhados para quem está em ${siteCopy.city}.`, icon: MapPin },
  { title: 'Serviços confirmados', text: `As principais frentes de atendimento entram organizadas para leitura rápida e decisão sem ruído.`, icon: Award },
  { title: 'Experiência da marca', text: `Ambiente, imagem e composição sustentam a identidade de ${siteCopy.name} sem inventar promessa.`, icon: Sparkles },
];
