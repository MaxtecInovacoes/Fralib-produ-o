...
# Salvar em arquivo
output_path = Path(__file__).parent.parent / "docs" / "SDR_DIAGNOSTICO_COMPLETO.md"
...
print(f"\n📄 Arquivo: {output_path}")
print("\n📋 RESUMO EXECUTIVO:")
print("   • 6 problemas identificados (2 críticos, 3 médios, 1 baixo)")
print("   • 3 opções de correção apresentadas")
print("   • Prioridade: Trocar modelo para Sonnet HOJE")
print("\n🔧 PRÓXIMO PASSO SUGERIDO:")
print("   Corrigir modelo de Haiku → Sonnet (10 min)")
print("   Unificar RAGs (30 min)")
print("   Testar com script: python scripts/test_sdr_bryan.py --relatorio")
print("=" * 80)