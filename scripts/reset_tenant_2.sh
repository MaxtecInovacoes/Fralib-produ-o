...
log ""
log "PROXIMOS PASSOS:"
log "  - Cron */10 vai reprocessar os leads pendente_wpp automaticamente"
log "  - Monitorar: tail -f /var/log/fralib-franz-cron.log"
log "  - Verificar: tail -f /var/log/fralib-api.log | grep -E 'Cron Franz|qualify'"