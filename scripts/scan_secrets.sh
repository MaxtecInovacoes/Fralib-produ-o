...
PATTERNS='(sk_live_[A-Za-z0-9]{30,}|sk_test_[A-Za-z0-9]{30,}|pk_live_[A-Za-z0-9]{30,}|pk_test_[A-Za-z0-9]{30,}|AKIA[A-Z0-9]{16}|sk-[A-Za-z0-9]{40,}|sk-ant-[A-Za-z0-9]{40,}|AIza[A-Za-z0-9]{30,}|ghp_[A-Za-z0-9]{36}|gho_[A-Za-z0-9]{36}|ghu_[A-Za-z0-9]{36}|ghs_[A-Za-z0-9]{36}|ghr_[A-Za-z0-9]{36}|xox[baprs]-[A-Za-z0-9-]{30,}|APP_USR-[0-9a-f]{20,}-[0-9]+-[A-Za-z0-9]+-[0-9a-f]+-[0-9a-f]+|TEST-[0-9]+-[0-9]+-[A-Za-z0-9]+-[0-9a-f]+-[0-9]+|whsec_[A-Za-z0-9]{30,}|-----BEGIN [A-Z]+ PRIVATE KEY-----|MERCADOPAGO_ACCESS_TOKEN=APP_USR-[0-9a-f-]{30,}|MERCADOPAGO_WEBHOOK_SECRET=APP_USR-[0-9a-f-]{30,}|MERCADOPAGO_WEBHOOK_SECRET=[A-Za-z0-9]{30,}|[^a-z_]sk_live_[a-zA-Z0-9]{30,}|[^a-z_]sk_test_[a-zA-Z0-9]{30,})'
