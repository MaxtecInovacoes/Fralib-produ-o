 ...
 * ============================================================================
 * Carrega todos os componentes modulares na ordem de dependência.
 * Módulos reais estão em /js/pixel-office/:
 *   - palette.js   → Paleta e funções de desenho
 *   - sprites.js   → Factory de sprites
 *   - agents.js    → Classes Agent e Bubble
 *   - layout.js    → Layout e loop de animação
 *
 * @deprecated Use /js/pixel-office/* modules directly
