...
A migração do `bryan.py` para `sdr_langgraph/` mantém 100% de compatibilidade com o resto do sistema. As funções `responder_lead`, `iniciar_contato` e `followup_automatico` têm a mesma assinatura.
